...
let s:palette.fg_idle_light   = {'dark': "#3E4B59",  'light': "#828C99",  'mirage': "#8e9faf"}
...
exe "hi! TabLine"       .s:fg_fg          .s:bg_line         .s:fmt_none
exe "hi! TabLineFill"   .s:fg_fg          .s:bg_line         .s:fmt_none
exe "hi! TabLineSel"    .s:bg_selection      .s:fg_accent      .s:fmt_bold
...
exe "hi! Todo"            .s:fg_file    .s:bg_none        .s:fmt_bold
...
exe "hi! NERDTreeFlags"             .s:fg_fg_idle_light       .s:bg_none        .s:fmt_none


exe "hi! NERDTreeFile"              .s:fg_file    .s:bg_none        .s:fmt_none
